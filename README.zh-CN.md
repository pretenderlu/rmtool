...
| reMarkable Paper Pro Move | `chiappa` | 支持 | 支持 | 支持 | 支持 | 支持 | 支持 |
...
| Paper Pro Move（`chiappa`） | 离线验证 | **实机验证** | 离线验证 | 离线验证 | 离线验证 | 离线验证 |
...
精确包现已覆盖 Paper Pro 与 Paper Pro Move 的 `3.27.1.0`、`3.27.3.0`、`3.28.0.162`、`3.28.0.163`、`3.28.0.164` 和 `3.28.0.166`。每个包同时校验硬件、架构、内部固件版本和 xochitl SHA-256；Paper Pro `3.28.0.166` 已通过实机验证，其余 11 个目标为官方固件离线验证。
...
| reMarkable Paper Pro Move | `chiappa` | 官方固件离线验证 | 官方固件离线验证 | 官方固件离线验证 | 官方固件离线验证 | 官方固件离线验证 | 官方固件离线验证 |
