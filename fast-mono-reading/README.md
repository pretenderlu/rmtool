...
| Platform | 3.27.1.0 (`20260506100933`) | 3.27.3.0 (`20260612085811`) | 3.28.0.162 beta (`20260629074044`) | 3.28.0.163 beta (`20260702125656`) |
| --- | --- | --- | --- | --- |
| Paper Pro (`ferrari`) | Offline verified | Offline verified | Offline verified | Offline verified |
...
`refresh-optimization/README.md`, then build all eight deterministic archives:

```powershell
python fast-mono-reading/build_assets.py `
...
hashtab, builds every output twice, and writes eight archives plus an aggregate
