...
- **Reading enhancements**: On exact supported Paper Pro and Paper Pro Move 3.27/3.28 builds, add one native Settings page for global tap-to-turn, fast monochrome, and forced-refresh controls. Each PDF/EPUB also keeps independent switches and a per-book refresh strategy. Paper Pro and Paper Pro Move 3.28.0.172 additionally provide precise Chinese/CJK highlight selection; Paper Pro is offline verified and still awaits real-device verification.
