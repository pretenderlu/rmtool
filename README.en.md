...
- **Reading enhancements**: On exact supported Paper Pro and Paper Pro Move 3.27/3.28 builds, add one native Settings page for global tap-to-turn, fast-mode authorization, and forced-refresh controls. Each PDF/EPUB reading menu then offers mutually exclusive normal, color-fast, and monochrome-fast modes plus the per-book refresh strategy. Color-fast preserves color with a more responsive refresh; monochrome-fast trades color for steadier monochrome output. Both modes affect only PDF/EPUB reading on color devices. Paper Pro and Paper Pro Move 3.28.0.172 additionally provide precise Chinese/CJK highlight selection; Paper Pro is offline verified and still awaits real-device verification.
