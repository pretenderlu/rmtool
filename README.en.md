...
- **Screen preview**: Paper Pro Move has a dedicated adaptive live-preview page with separate start and stop controls, manual refresh, and PNG Save As. It updates as quickly as serialized device reads allow, creates no library document, and removes its temporary device-side buffer after transfer.
