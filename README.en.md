...
- **Screen preview**: Paper Pro Move has a dedicated live-preview page with manual refresh, 2/5/10-second continuous refresh, and PNG Save As. It creates no library document, and removes its temporary device-side buffer after transfer.
