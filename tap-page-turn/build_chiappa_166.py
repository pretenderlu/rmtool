"""Build the exact Paper Pro Move 3.28.0.166 tap-to-turn package."""
...
TARGET_ASSET = (
    "rmtool-tap-page-turn-chiappa-20260806095513-3.28.0.166.tar.gz"
)
HASHTAB_SIZE = 618898
HASHTAB_SHA256 = (
    "8a104b5b9c4be82b04609c3c28b7fb131a8ea82f02c76438472a94dcde8ec159"
)
...
def _qmd_check(qmd_tool: Path, hashtab: bytes, qmd: bytes) -> None:
    with tempfile.TemporaryDirectory() as temporary:
        ...
        hashtabs.mkdir()
        qmds.mkdir()
        (hashtabs / "hashtab-chiappa-20260806095513").write_bytes(hashtab)
...
def _build(
    ...
    if len(hashtab) != HASHTAB_SIZE or sha256(hashtab) != HASHTAB_SHA256:
        raise RuntimeError("Paper Pro Move 3.28.0.166 hashtab does not match the gate")
    with tempfile.TemporaryDirectory() as temporary:
